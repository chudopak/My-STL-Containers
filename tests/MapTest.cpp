...
void	MapTest() {
	...
	}
	{
		...
		std::cout << std::endl << YELLOW << "\ttesting triky erase(k), erase(iterator)" << STANDART << std::endl;
	...
	{
		std::cout << std::endl << BOLD_GREEN << "\tTEST erase(iterator, iterator)" << STANDART << std::endl;
		...
		for (int i = 0; i < 10000; i += 4) {
			ftMap.insert(ft::make_pair(i, i + 1));
			ftMap.insert(ft::make_pair(i - 1, i + 1));
			ftMap.insert(ft::make_pair(-i + 1, -i + 1));
		}
		...
		long	ftEndMil = ftEnd.tv_sec * 1000 + ftEnd.tv_usec / 1000;
		long	ftDiff = ftEndMil - ftStartMil;
		print_data_of_compared(stdMap, ftMap);
		print_time_map(stlDiff, ftDiff);
		...
		ftTree.erase(++ftTree.begin(), --ftTree.end());
		...
		stdTree.erase(++stdTree.begin(), --stdTree.end());
		print_data_of_compared(stdTree, ftTree);
	}

	{
		std::cout << std::endl << BOLD_GREEN << "\tTEST lower_bounds" << STANDART << std::endl;
		...
		std::map<int, int, std::greater<int> >	stdmp2;
		stdmp.insert(std::make_pair(10, 10));
		stdmp2.insert(std::make_pair(10, 10));
		if (stdmp.lower_bound(11) == stdmp.end())
			stdvec.push_back(1);
		if (stdmp2.lower_bound(1) == stdmp2.end())
			stdvec.push_back(1);
		stdmp.insert(std::make_pair(15, 0));
		stdmp.insert(std::make_pair(10, 0));
		stdmp.insert(std::make_pair(1, 0));
		stdmp.insert(std::make_pair(12, 0));
		stdmp.insert(std::make_pair(30, 0));
		stdmp.insert(std::make_pair(22, 0));
		stdmp.insert(std::make_pair(25, 0));
		stdmp.insert(std::make_pair(20, 0));
		stdmp.insert(std::make_pair(40, 0));
		stdmp.insert(std::make_pair(33, 0));
		stdmp.insert(std::make_pair(31, 0));
		stdmp.insert(std::make_pair(32, 0));
		stdmp.insert(std::make_pair(39, 0));
		stdmp.insert(std::make_pair(50, 0));
		stdmp.insert(std::make_pair(60, 0));

		stdmp2.insert(std::make_pair(15, 0));
		stdmp2.insert(std::make_pair(10, 0));
		stdmp2.insert(std::make_pair(1, 0));
		stdmp2.insert(std::make_pair(12, 0));
		stdmp2.insert(std::make_pair(30, 0));
		stdmp2.insert(std::make_pair(22, 0));
		stdmp2.insert(std::make_pair(25, 0));
		stdmp2.insert(std::make_pair(20, 0));
		stdmp2.insert(std::make_pair(40, 0));
		stdmp2.insert(std::make_pair(33, 0));
		stdmp2.insert(std::make_pair(31, 0));
		stdmp2.insert(std::make_pair(32, 0));
		stdmp2.insert(std::make_pair(39, 0));
		stdmp2.insert(std::make_pair(50, 0));
		stdmp2.insert(std::make_pair(60, 0));
		std::map<int, int>::iterator it;
		for (int i = 1; i < 60; i += 10) {
			it = stdmp.lower_bound(i);
			stdvec.push_back(it->first);
		}
		for (int i = 11; i < 70; i += 10) {
			it = stdmp2.lower_bound(i);
			stdvec.push_back(it->first);
		}
		std::map<int, int> stdmp3;
		for (int i = 0, j = 0; i < 100000; ++i, ++j) {
				stdmp3.insert(std::make_pair(i, j));
		}
		stdmp3.lower_bound(90000);
		...
		std::vector<int> ftvec;
		ft::map<int, int, std::greater<int> >	ftmp;
		ft::map<int, int, std::greater<int> >	ftmp2;
		ftmp.insert(ft::make_pair(10, 10));
		ftmp2.insert(ft::make_pair(10, 10));
		if (ftmp.lower_bound(11) == ftmp.end())
			ftvec.push_back(1);
		if (ftmp2.lower_bound(1) == ftmp2.end())
			ftvec.push_back(1);
		ftmp.insert(ft::make_pair(15, 0));
		ftmp.insert(ft::make_pair(10, 0));
		ftmp.insert(ft::make_pair(1, 0));
		ftmp.insert(ft::make_pair(12, 0));
		ftmp.insert(ft::make_pair(30, 0));
		ftmp.insert(ft::make_pair(22, 0));
		ftmp.insert(ft::make_pair(25, 0));
		ftmp.insert(ft::make_pair(20, 0));
		ftmp.insert(ft::make_pair(40, 0));
		ftmp.insert(ft::make_pair(33, 0));
		ftmp.insert(ft::make_pair(31, 0));
		ftmp.insert(ft::make_pair(32, 0));
		ftmp.insert(ft::make_pair(39, 0));
		ftmp.insert(ft::make_pair(50, 0));
		ftmp.insert(ft::make_pair(60, 0));

		ftmp2.insert(ft::make_pair(15, 0));
		ftmp2.insert(ft::make_pair(10, 0));
		ftmp2.insert(ft::make_pair(1, 0));
		ftmp2.insert(ft::make_pair(12, 0));
		ftmp2.insert(ft::make_pair(30, 0));
		ftmp2.insert(ft::make_pair(22, 0));
		ftmp2.insert(ft::make_pair(25, 0));
		ftmp2.insert(ft::make_pair(20, 0));
		ftmp2.insert(ft::make_pair(40, 0));
		ftmp2.insert(ft::make_pair(33, 0));
		ftmp2.insert(ft::make_pair(31, 0));
		ftmp2.insert(ft::make_pair(32, 0));
		ftmp2.insert(ft::make_pair(39, 0));
		ftmp2.insert(ft::make_pair(50, 0));
		ftmp2.insert(ft::make_pair(60, 0));
		ft::map<int, int>::iterator ftit;
		for (int i = 1; i < 60; i += 10) {
			ftit = ftmp.lower_bound(i);
			ftvec.push_back(ftit->first);
		}
		for (int i = 11; i < 70; i += 10) {
			ftit = ftmp2.lower_bound(i);
			ftvec.push_back(ftit->first);
		}
		ft::map<int, int> ftmp3;
		for (int i = 0, j = 0; i < 100000; ++i, ++j) {
				ftmp3.insert(ft::make_pair(i, j));
		}
		ftmp3.lower_bound(90000);
	...
	{
		std::cout << std::endl << BOLD_GREEN << "\tTEST operator[]" << STANDART << std::endl;

		ft::map<char, std::string>	ftmp;

		ftmp['a'] = "an element";
		ftmp['b'] = "another element";
		ftmp['c'] = ftmp['b'];
		ftmp['b'] = "old element";
		ftmp['u'] = "u";
		ftmp['y'] = "a";
		ftmp['z'] = "yie";
		std::map<char, std::string>	stdmp;


		stdmp['a'] = "an element";
		stdmp['b'] = "another element";
		stdmp['c'] = stdmp['b'];
		stdmp['b'] = "old element";
		stdmp['u'] = "u";
		stdmp['y'] = "a";
		...
		print_data_of_compared(stdmp, ftmp);
	}
}